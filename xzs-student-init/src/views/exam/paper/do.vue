   ...
   <!-- <el-row  class="do-exam-title">
      <el-col :span="24">
        <span :key="index"  v-for="(answerItems,index) in answer.answerItems">
             <el-tag :type="questionCompleted(answerItems.completed)" class="do-exam-title-tag" @click="goAnchor('#question-'+index)">{index}}</el-tag>
        </span>
        ...
        <el-form :model="form" ref="form" v-loading="formLoading" label-width="100px">
          <el-row :key="index"  v-for="(titleItem,index) in form.titleItems">
            ...
            <el-card class="exampaper-item-box" v-if="titleItem.questionItems.length!==0">
              <el-form-item :key="questionItem.itemOrder" :label="qIndex+1+'.'"
           ...
           <el-row class="do-align-center">
             <el-button type="primary" @click="submitForm">提交</el-button>
              <router-link target="_blank" :to="{path:'paper/index'}">
